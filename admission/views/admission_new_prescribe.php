...
function load_drug_name(id){
	...
	var request = $.ajax({
		url: "<?php echo base_url(); ?>index.php/lookup/get_ward_drug",
		type: "post",
...
function select_type(type_id){
	current_drug.d_type = $("#blk_drug_type_list option:selected").text();
	var typ = current_drug.d_type;
